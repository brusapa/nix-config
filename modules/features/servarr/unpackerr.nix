      ...
      in
      {
        ...
        virtualisation.oci-containers.containers.unpackerr = {
          ...
          environment = {
            ...
            ## Sonarr Settings
            UN_SONARR_0_URL = "https://sonarr.${config.reverseProxy.baseDomain}";
            ...
            ## Radarr Settings
            UN_RADARR_0_URL = "https://radarr.${config.reverseProxy.baseDomain}";
            ...
            ## Lidarr Settings
            UN_LIDARR_0_URL = "http://lidarr.${config.reverseProxy.baseDomain}";
